...
Кроки:  
1. завантажте останній реліз "CombaCart extras" з [github.com](https://github.com/zatomant/combacart-extras)
...
Крок 5 має "захист" - виконується перевірка наявності теки 'combacart/vendor', і якщо присутня - інсталяція буде зупинена.   